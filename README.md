...
Заголовочные **89% / 78%**. Независимые прогоны при `temperature 0` дают
88–89% по месту и 77–78% по типу: разброс в один-два дефекта, весь он
в слое модели, слой правил даёт константу. Разброс назван честно,
а не сглажен усреднением.
