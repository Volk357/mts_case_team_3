...
хранит только серверную привязку и разрешённый относительный locator. Клиент
выбирает опубликованный идентификатор; путь к пакету никогда не передаётся и
не возвращается.
