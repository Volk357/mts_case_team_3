  ...
  "items": [
    {
      ...
      "version": "1.0",
      "description": "Проверка полноты и однозначности технических требований."
    }
  ],
  "total": 1
}
...
Название, тип документа и описание читаются из манифеста Review Pack. База
хранит только серверную привязку и разрешённый относительный locator, а название
компании берётся из tenant-записи. Клиент выбирает опубликованный идентификатор;
путь к пакету никогда не передаётся, не возвращается и не принимается API.
...
Каждая строка хранит выбранную версию Review Pack вместе с документом. Поэтому
два запуска с разными профилями остаются различимыми после завершения:
  ...
  "items": [
    {
      "review_id": "33333333-3333-4333-8333-333333333333",
      "document_id": "22222222-2222-4222-8222-222222222222",
      "document_filename": "generic-notification-service.docx",
      "review_pack_id": "11111111-1111-4111-8111-111111111111",
      "review_pack_name": "Универсальная техническая спецификация",
      "review_pack_version": "1.0",
      "status": "completed",
      "queued_at": "2026-09-05T16:00:00Z",
      "finished_at": "2026-09-05T16:01:00Z",
      "findings_count": 6
    }
  ],
  "total": 1
...
### 7. Сохранить решение по замечанию
