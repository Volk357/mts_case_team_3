...
PLANS = [
    ("synth_1", "traffic", [
        "DANGLING_REFERENCE", "INTERNAL_CONTRADICTION", "UNDEFINED_EDGE_CASE",
        "AMBIGUOUS_LOGIC", "UNSPECIFIED_FORMAT", "DUPLICATE_SEMANTICS",
        "SCHEMA_INCONSISTENCY", "MISSING_SOURCE_LOCATION", "PLACEHOLDER_LEFT",
    ...
    ("synth_2", "radio", [
        ...
        "SCHEMA_INCONSISTENCY", "DATA_CATALOG_MISSING", "HDFS_PATH_INCOMPLETE",
        "TEMPLATE_SECTION_MISSING_DDL", "PLACEHOLDER_LEFT_JIRA",
        "TEXT_STRUCTURE_ERROR", "DANGLING_REFERENCE", "AMBIGUOUS_LOGIC",
    ]),
    ("synth_3", "churn", [
